...
game = fs.readFileSync(game)
pay = fs.readFileSync(payrs)
// language
...
if (!m.isGroup) return reply(lang.groupOnly())
	    ...
	    case 'toimage': case 'toimg': {
            ...
            break
  case 'formatmlbb':
  reply(`Hai kak ${pushname} 👋 selamat ${salam} ,
  SEBELUM ORDER ISI FORMAT MLBB NYA YA KK🙏🏻😇
MAFF YA INI CUMAN CONTOH SAJA...!!
...
╰────────────┈ ⳹
*───┤INFO SINGKAT├───*
Ⓜ️ PEROSES SESUAI ID GAME KALIAN JADI MOHON BERSABAR ☺️
Ⓜ️ GUNAN NYA NOMOR DANA KALIAN APA BILA SAYA INGIN FRV UANG DI SAT SAYA LG KOSBAR
*───┤WARNING├───*
APA BILA SALA ID MAKA BUKAN TANGUNG JAWAB ADMIN JADI PERHATIKAN ID DENGAN BENAR YA`)
            break
case 'formatff':
reply(`HALO KK ${pushname}, selamat ${salam} ,
SEBELUM ORDER ISI FORMAT FERE FIRE NYA YA KK🙏🏻😇
MAFF YA INI CUMAN CONTOH SAJA...!!
...
case 'formatcip':
reply(`HALO KK ${pushname}, selamat ${salam} ,
SEBELUM ORDER ISI FORMAT CIP DOMINO NYA YA KK🙏🏻😇
MAFF YA INI CUMAN CONTOH SAJA...!!

╭─⧉  *FORMAT CIP DOMINO ONLINE* ]
├⧉  ID : 123456789
├⧉  NICK :  ${pushname}
├⧉  ORDER : 100B
├⧉ NO DANA KALIAN : 0823########
╰────────────┈ ⳹
   ...
   *───┤INFO SINGKAT├───*
Ⓜ️ PEROSES SESUAI ID DOMINO KALIAN JADI MOHON BERSABAR ☺️
Ⓜ️ GUNAN NYA NOMOR DANA KALIAN APA BILA SAYA INGIN FRV UANG DI SAT SAYA LG KOSBAR
     *───┤WARNING├───*
APA BILA SALA ID MAKA BUKAN TANGUNG JAWAB ADMIN JADI PERHATIKAN ID DENGAN BENAR YA`)
break
case 'formatsosmed':
reply(`HALO KK ${pushname}, selamat ${salam} ,
SEBELUM ORDER ISI FORMAT SOSMED NYA YA KK🙏🏻😇
MAFF YA INI CUMAN CONTOH SAJA...!!

INI KUSUS TIKTOK
╭─⧉ *FORMAT SOSMED SI RAKUN*
├⧉  LING : https//:tiktok.com/@rs.rakun
├⧉  NAMA : ${pushname}
├⧉ JUMLAH ORDERAN : 10000 
├⧉ TARGET : FOLOWER/LIKE/SHARE
╰────────────┈ ⳹
   *───┤INFO SINGKAT├───*
Ⓜ️ PEROSES SESUAI LING SOSMED KALIAN JADI MOHON BERSABAR ☺️
     *───┤WARNING├───*
APA BILA SALA LING SOSMED MAKA BUKAN TANGUNG JAWAB ADMIN JADI PERHATIKAN ID DENGAN BENAR YA

INI KUSUS IG/INSTAGRAM
╭─⧉ *FORMAT SOSMED SI RAKUN*
├⧉  LING : https://instagram.com/Rakunshop?igshid=YmMyMTA2M2Y=
├⧉  NAMA : ${pushname}
├⧉ JUMLAH ORDERAN : 10000 
├⧉ TARGET : FOLOWER/LIKE/SHARE
╰────────────┈ ⳹
...
➛ BEBAS DALAM PEMAKAYAN
➛ PERATURAN CUMAN 2
📌 JANGAN KIK BOT
📌 JANGAN SEPAM BOT APA BILA DALAM PERBAIKAN
*──────────────*

╭─⧉ *PAKET JADI BOT*
├ Rp. 30.000 BOT ADDLIST BUATAN RS /DATA ORI
├ Rp. 25.000 BOT ADDLIST BUATAN ZeeoneOfc /ENC
╰────────────┈ ⳹
*───┤KEUNTUNGAN JADI BOT├───*
➛ Wajip ada akun google agar di buatkan bot nya. 
➛ Mempunya i watsapp 2 dalam 1 hp 
➛ Wajip ada 2 hp buat seken qris Baten Botz
*──────────────*

*❒ BOT MULTI GITHUP + HEROKU ❒*`)
            break
            case 'public': {
                if (!m.key.fromMe && !isCreator) return reply(lang.ownerOnly())
                alpha.public = true
...
case 'format':{
					if(typemenu == 'templateLocation'){
						await alpha.send5ButLoc(from, lang.format(salam, pushname, botname) , `© ${ownername}`,game, [{"urlButton": {"displayText": "👤OWNER BOT🤖","url": `${ownernomerrr}`}},{"quickReplyButton": {"displayText": "🎮MLBB.ID","id": 'formatmlbb'}},{"quickReplyButton": {"displayText": "🎮 FREE FIRE","id": 'formatff'}},{"quickReplyButton": {"displayText": "🎮PUBG MOBILE","id": 'formatpubg'}}] )
							}
							}
 break 
 case 'payrs':{
...
{
            "quickReplyButton": {
              "displayText": "🎮PUBG MOBILE",
"id": 'formatpubg'
            }
          }
        ]
        await alpha.send5ButImg(from, lang.payrs(ownernomer) , `© ${ownername}`,pay, but , { userJid: m.chat, quoted: m })
    }
 break
//Random Anime
...
break
            ...
            break
				case 'menu':{
					if(typemenu == 'templateLocation'){
						await alpha.send5ButLoc(from, lang.menunya(salam, pushname, botname) , `© ${ownername}`,pp_bot, [{"urlButton": {"displayText": "👤OWNER BOT🤖","url": `${ownernomerrr}`}},{"quickReplyButton": {"displayText": "🎦DONASI","id": 'donate'}},{"quickReplyButton": {"displayText": "📚ALLMENU","id": 'allmenu'}},{"quickReplyButton": {"displayText": "📔BUTON MENU","id": 'command'}}] )
							}
						if(typemenu == 'templateTenor'){
							alpha.send5ButGif(from, lang.menunya(salam, pushname, botname) , `© ${ownername}` ,pp_bot, [{"urlButton": {"displayText": "👤OWNER BOT🤖","url": `${ownernomerrr}`}},{"quickReplyButton": {"displayText": "🎦DONASI","id": 'donate'}},{"quickReplyButton": {"displayText": "📔BUTON MENU","id": 'command'}}] , {quoted: m})
						 }
						if(typemenu == 'katalog'){
...
break
			...
			case 'ramalanjodoh': case 'ramaljodoh': {
                if (!text) throw `Example : ${prefix + command} , 12, 1, 2004, Clara, 22, 2, 2004`
            ...
            break
            case 'fengshui': {
                if (!text) throw `Example : ${prefix + command} , 1, 2004\n\nNote : ${prefix + command} Nama, gender, tahun lahir\nGender : 1 untuk laki-laki & 2 untuk perempuan`
            ...
            break
            case 'peruntungan': {
                if (!text) throw `Example : ${prefix + command} , 12, 1, 2004, 2022\n\nNote : ${prefix + command} Nama, tanggal lahir, bulan lahir, tahun lahir, untuk tahun`
...
if (!text.includes('|')) return reply(`Kirim perintah ${prefix + command} *Rakun|ofc*`)
mm = args.join(' ')
m1 = mm.split("|")[0];
m2 = mm.split("|")[1]; 
reply(lang.wait())
...
alpha.sendMessage(from, {image:{ url: textpro2}, caption: lang.ok()}, {quoted:m})
	...
	break
case 'astronotspace':{
	if (!text) return reply(`Ex: ${prefix + command} nama|style\nUsage: ${prefix + command} rakunbot|anubis`)
	if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|style\nUsage: ${prefix + command} rakunbot|anubis`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
alpha.sendMessage(from, {image:{ url: textpro2}, caption: lang.ok()}, {quoted:m})
	...
	break
case 'wallpaperaov':{
	if (!text) return reply(`Ex: ${prefix + command} nama|heroes\nUsage: ${prefix + command} rakunbot|allain`)
	if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|heroes\nUsage: ${prefix + command} rakunbot|allain`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
alpha.sendMessage(from, {image:{ url: textpro2}, caption: lang.ok()}, {quoted:m})
	...
	break
case 'wallpaperml':{
	if (!text) return reply(`Ex: ${prefix + command} nama|heroes\nUsage: ${prefix + command} rakunbot|aldous`)
	if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|heroes\nUsage: ${prefix + command} rakunbot|aldous`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
alpha.sendMessage(from, {image:{ url: textpro2}, caption: lang.ok()}, {quoted:m})
	...
	break
case 'bannerofaov':{
	if (!text) return reply(`Ex: ${prefix + command} nama|character\nUsage: ${prefix + command} rakunbot|aphelios`)
	if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|character\nUsage: ${prefix + command} rakunbot|aphelios`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
alpha.sendMessage(from, {image:{ url: textpro2}, caption: lang.ok()}, {quoted:m})
	...
	break
case 'cutegirlgamer':{
	if (!text) return reply(`Ex: ${prefix + command} nama|logo\nUsage: ${prefix + command} rakunbot|style-1`)
	if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|logo\nUsage: ${prefix + command} rakunbot|style-1`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
alpha.sendMessage(from, {image:{ url: textpro2}, caption: lang.ok()}, {quoted:m})
	...
	break
case 'anonymous':{
	if (!text) return reply(`Ex: ${prefix + command} nama|style\nUsage: ${prefix + command} rakunbot|style2`)
	if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|style\nUsage: ${prefix + command} rakunbot|style2`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
alpha.sendMessage(from, {image:{ url: textpro2}, caption: lang.ok()}, {quoted:m})
	...
	break
	case 'crossfirecover':{
if (!text) return reply(`Ex: ${prefix + command} nama|character\nUsage: ${prefix + command} |blthefates`)
if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|character\nUsage: ${prefix + command} |blthefates`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
if (!text) return reply(`Ex: ${prefix + command} nama|character\nUsage: ${prefix + command} |dieuthuyen`)
if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|character\nUsage: ${prefix + command} |dieuthuyen`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
